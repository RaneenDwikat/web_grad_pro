...
class orderHeader2 extends StatefulWidget {
  var phonenumber;
  orderHeader2(this.phonenumber);

  @override
  _orderHeader2 createState() => _orderHeader2(phonenumber);
}

class _orderHeader2 extends State<orderHeader2> {
  var phonenumber, search, name, newphonenumber, password;
  List items = [];
  _orderHeader2(this.phonenumber);
  @override
  void initState() {
