...
import 'package:untitled3/manager/Home/Tables/ProjectWidget5.dart';
import 'package:untitled3/model.dart/responsive.dart';
import 'package:untitled3/manager/Home/Sidebar/sidebar.dart';
import 'package:untitled3/manager/Home/dashboard/component/headerorder.dart';

class Dashorder extends StatelessWidget {
  Dashorder(this.phonenumber);
  var phonenumber;
  @override
                ...
                children: [
                  Responsive(
                      mobile: _size.width <= 420
                          ...
                          : orderHeader2(phonenumber),
                      desktop: orderHeader2(phonenumber)),
                  SizedBox(
                    height: 20,
                  ),
                  SizedBox(
