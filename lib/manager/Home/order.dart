...
import 'package:untitled3/manager/Home/dashboard/dashboardorder.dart';
...
class Orders extends StatefulWidget {
  var phonenumber;
  Orders(this.phonenumber);

  @override
  _Orders createState() => _Orders(phonenumber);
}

class _Orders extends State<Orders> {
  var phonenumber;
  _Orders(this.phonenumber);
  @override
          ...
          Expanded(
              ...
              child: ListView(
                children: [
                  Row(
                    children: [
                      Expanded(flex: 4, child: Dashorder(phonenumber)),
