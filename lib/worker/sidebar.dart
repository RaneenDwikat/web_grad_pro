...
class SideBarworker extends StatefulWidget {
  SideBarworker(this.phonenumber);
  var phonenumber;
  @override
  _SideBarworker createState() => _SideBarworker(phonenumber);
}
...
class _SideBarworker extends State<SideBarworker> {
  var phonenumber;
  _SideBarworker(this.phonenumber);
